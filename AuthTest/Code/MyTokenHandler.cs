...
namespace NiHaoCookie
{
    ...
    public class CustomBearerEvents : Microsoft.AspNetCore.Authentication.JwtBearer.JwtBearerEvents
    {
        /*
        //
        // Summary:
        ...
        */
        ...
        {
            this.OnAuthenticationFailed = context => Task.FromResult(0);
            this.OnMessageReceived = context => Task.FromResult(0);
            this.OnTokenValidated = context => Task.FromResult(0);
            this.OnChallenge = context => Task.FromResult(0);
        }
        ...
        {
            return this.OnMessageReceived(context);
        }

        public override Task TokenValidated(TokenValidatedContext context)
        {
            return this.TokenValidated(context);
        }
    }
    ...
    public class MyTokenHandler : Microsoft.IdentityModel.Tokens.ISecurityTokenValidator
    {
        ...
        int ISecurityTokenValidator.MaximumTokenSizeInBytes
        {
            get
            {
                return tokenHandler.MaximumTokenSizeInBytes;
                // return this.m_MaximumTokenByteSize;
            }

            set
            {
                tokenHandler.MaximumTokenSizeInBytes = value;
        ...
        {
            // var validatedToken = new JwtSecurityToken(securityToken);
            try
            {
